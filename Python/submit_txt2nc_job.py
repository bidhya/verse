...
def create_job(jobname='txt2nc', cores=1, memory='16gb', runtime='06:00:00', out_subfolder="NA_2016", var_name=None, var_idx=None):
    ...
    with open(job_file, 'w') as fh:
        ...
        fh.writelines(f"julia /discover/nobackup/projects/coressd/Blender/verse/Julia/combine_txt2csv.jl NA_2016 {var_name} {var_idx}\n\n")
...
def main():
    ...
    create_job(jobname="txt2nc1", var_name="SWE", var_idx=1, out_subfolder=out_subfolder, cores=1, memory='16gb', runtime='05:00:00')
    create_job(jobname="txt2nc2", var_name="Gmelt", var_idx=2, out_subfolder=out_subfolder, cores=1, memory='16gb', runtime='05:00:00')
    create_job(jobname="txt2nc3", var_name="G", var_idx=3, out_subfolder=out_subfolder, cores=1, memory='16gb', runtime='05:00:00')
    create_job(jobname="txt2nc4", var_name="Precip", var_idx=4, out_subfolder=out_subfolder, cores=1, memory='16gb', runtime='05:00:00')
    create_job(jobname="txt2nc5", var_name="Us", var_idx=5, out_subfolder=out_subfolder, cores=1, memory='16gb', runtime='05:00:00')
    create_job(jobname="txt2nc6", var_name="Gpv", var_idx=6, out_subfolder=out_subfolder, cores=1, memory='16gb', runtime='05:00:00')
    create_job(jobname="txt2nc7", var_name="Gmeltpv", var_idx=7, out_subfolder=out_subfolder, cores=1, memory='16gb', runtime='05:00:00')
    create_job(jobname="txt2nc8", var_name="Upv", var_idx=8, out_subfolder=out_subfolder, cores=1, memory='16gb', runtime='05:00:00')
    create_job(jobname="txt2nc9", var_name="SWEpv", var_idx=9, out_subfolder=out_subfolder, cores=1, memory='16gb', runtime='05:00:00')
