...
destination = source.replace('03_Blender', '03_Blender/paper_outputs')
destination = destination.replace('.ipynb', f'_{water_year}.ipynb')  # save notebooks outputs by water year
