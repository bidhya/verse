...
Oct 06, 2025 : Add precipitation scalar code #jld
"""
arg_len = length(ARGS)
...
@everywhere include("Estimate_v2.jl")  #https://docs.julialang.org/en/v1/manual/code-loading/; evaluated in global scope
...
PrecipDir = "$root_dir/projects/coressd/PrecipScalarFiles"
